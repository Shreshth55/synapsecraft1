...
@Component({
    ...
    template: ` <div class="card">
            <div class="font-semibold text-xl mb-4">Agent History</div>
            <p-table
                #dt1
                [value]="customers1"
                dataKey="id"
        ...
        <div class="card">
            <div class="font-semibold text-xl mb-4">AI AGENTS Transaction History</div>
            ...
            <p-table [value]="customers2" [scrollable]="true" scrollHeight="400px" styleClass="mt-4">
                <ng-template #header>
                    <tr>
                        <th style="min-width:200px" pFrozenColumn class="font-bold">User Name</th>
        ...
        <div class="card">
            <div class="font-semibold text-xl mb-4">WORK SAMPLES</div>
        ...
        <div class="card">
            <div class="font-semibold text-xl mb-4">Popular Customer of SYNAPSECRAFT</div>
